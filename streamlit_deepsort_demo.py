...
INPUT_PATH="C:/Users/epchanws/Downloads/yolov4-deepsort-master/streamlit/videos/"
SELECT_VIDEO_PATH="C:/Users/epchanws/Downloads/yolov4-deepsort-master/streamlit/videos_to_select/"
...
st.text("")
st.write("The Deep SORT tracking algorithm uses a parameter called 'age', which is the length of time after which a tracked ID is considered to have left the scene.") 
